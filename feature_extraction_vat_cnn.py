# taken from vertical attention paper
import random

from torch.nn import (Conv2d, Dropout, Dropout2d, InstanceNorm2d, Module,
                      ModuleList, ReLU)
...
class DepthSepConv2D(Module):
    def __init__(self, in_channels, out_channels, kernel_size, activation=None, padding=True, stride=(1, 1), dilation=(1, 1)):
        ...
        self.depth_conv = Conv2d(
            in_channels=in_channels, out_channels=in_channels, kernel_size=kernel_size, dilation=dilation,
